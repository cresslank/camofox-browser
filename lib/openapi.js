/**
 * Committed OpenAPI spec + docs UI (swagger-stripey).
 *
 * swagger-jsdoc is a development-only generator. Runtime serves the committed
 * spec so published installs do not need the generator dependency.
